...
local Window = OrionLib:MakeWindow({Name = "lain中心", HidePremium = false, SaveConfig = true,IntroText = "lain脚本", ConfigFolder = "lain中心"})
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "lain脚本"; Text ="lain脚本"; Duration = 4; })
